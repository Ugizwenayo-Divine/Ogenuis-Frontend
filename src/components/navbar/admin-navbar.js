      ...
      return (
        <div 
          ...
          <span className="nav-item active">
            ...
            <span 
              onClick={()=>{this.handleClick(['question'],'add')}} 
              onMouseOver={()=>{this.handleHover(['question'],'add')}} 
              onMouseOut= {this.handleUnHover} >
              <a className="nav-link" href="#">ADD</a>
            </span>
          <span 
          className="nav-item"
          onClick={()=>{this.handleClick(['user','grade','question'],'display')}} 
          onMouseOver={()=>{this.handleHover(['user','grade','question'],'display')}} 
          onMouseOut= {this.handleUnHover} >
