...
const mapStateToProps = ({getAllGrades:{loading, data, message, questionErrors}}) => {
  console.log(data);
    return {
        loading,
        message,
...
export default connect(mapStateToProps,{getAllGrades})(AllGrades);